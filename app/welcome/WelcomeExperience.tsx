...
const pilotMessages: Record<ActionType | "start", PilotState> = {
  ...
  cards: {
    ...
    message:
      "Визитки отлично подходят для старта: их можно распечатать даже на обычном принтере и раздать первым клиентам.",
  },
  telegram: {
    title: "Отлично, идём в мессенджеры.",
    message:
      "Я подготовил короткий текст. Его можно отправить постоянным клиентам или закрепить в профиле.",
  },
  car: {
    title: "QR на автомобиле — сильная идея.",
    message:
      "Так клиент сможет быстро оставить обращение, даже если увидел вас по дороге или во дворе.",
  },
  clients: {
    title: "Начинаем с тех, кто уже вас знает.",
    message:
      "Постоянные клиенты чаще всего становятся первыми, кто попробует новый способ связи.",
  },
};
...
export default function WelcomeExperience({
  ...
  return (
    <main className="h-screen overflow-hidden bg-[#f4f5f7] px-4 py-4 text-black">
      <div className="mx-auto grid h-full max-w-7xl gap-5 lg:grid-cols-[1.04fr_0.96fr]">
        <section className="flex min-h-0 flex-col rounded-[36px] border border-black/[0.04] bg-white px-8 py-7 shadow-sm">
          ...
          <div className="mt-6 flex min-h-0 flex-1 flex-col rounded-[30px] border border-black/[0.06] bg-[#f8f8fa] p-4">
            <div className="flex flex-1 items-center justify-center rounded-[26px] bg-white p-4 shadow-[0_18px_50px_rgba(0,0,0,0.08)]">
              <img
                src={qrImageUrl}
                alt="Персональный QR-код ПУЛЬС"
                className="max-h-[300px] w-auto rounded-3xl"
              />
            </div>
            ...
            <button
              onClick={copyQrUrl}
              className="mt-3 flex h-11 items-center justify-center gap-2 rounded-2xl border border-black/[0.06] bg-white px-5 text-sm font-black shadow-sm transition hover:bg-zinc-50"
            >
          ...
          <div className="mt-5 rounded-[24px] border border-emerald-100 bg-emerald-50/70 p-4">
            <div className="flex gap-4">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-white text-emerald-500 shadow-sm">
                <Heart className="h-6 w-6 fill-emerald-500/15" />
              </div>
        ...
        <aside className="flex min-h-0 flex-col rounded-[36px] border border-white/10 bg-[#050607] px-7 py-7 text-white shadow-sm">
          <div className="flex items-center gap-4">
            <div className="flex h-13 w-13 items-center justify-center rounded-3xl bg-white text-black">
            ...
            {[
              ...
              return (
                <button
                  ...
                  className="group relative flex items-center gap-4 overflow-hidden rounded-[24px] border border-white/[0.06] bg-white/[0.06] p-4 text-left transition hover:border-emerald-400/60 hover:bg-white/[0.09]"
                >
                  ...
                  <div className="flex h-13 w-13 shrink-0 items-center justify-center rounded-2xl bg-white/[0.08]">
          ...
          <div className="mt-6 flex-1 overflow-hidden rounded-[30px] border border-emerald-400/70 bg-white/[0.04] shadow-[0_0_50px_rgba(52,211,153,0.14)]">
            <div className="relative h-full p-5">
              ...
              <div className="relative flex items-start justify-between gap-4">
                ...
                <div className="relative flex h-20 w-20 shrink-0 items-center justify-center rounded-full bg-white shadow-[0_0_40px_rgba(52,211,153,0.35)]">
                  <div className="absolute inset-2 rounded-full bg-zinc-100" />
                  <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#101214]">
                    <div className="absolute -left-3 top-4 h-7 w-4 rounded-l-full bg-zinc-300" />
                    <div className="absolute -right-3 top-4 h-7 w-4 rounded-r-full bg-zinc-300" />
                    <div className="flex gap-2">
                      <span className="h-3 w-3 animate-pulse rounded-full bg-emerald-400" />
                      <span className="h-3 w-3 animate-pulse rounded-full bg-emerald-400 [animation-delay:200ms]" />
                    </div>
                    <div className="absolute bottom-3 h-1.5 w-6 rounded-full bg-emerald-400/80" />
                  </div>
                </div>
              </div>

              <div className="relative mt-4 rounded-[24px] border border-white/[0.06] bg-white/[0.08] p-5">
          ...
          <div className="w-full max-w-xl rounded-[32px] bg-white p-6 shadow-2xl">
            ...
            {activeAction === "cards" && (
              <div className="mt-6 space-y-4">
                ...
                <div className="rounded-3xl border border-black/[0.06] p-4">
                  <div className="font-black">Стиль</div>
                  <div className="mt-3 grid gap-2 sm:grid-cols-3">
                    {["Минимализм", "Современный", "Классический"].map(
                      (item) => (
                        <button
                          key={item}
                          className="rounded-2xl border border-black/[0.08] px-4 py-3 text-sm font-bold transition hover:border-emerald-400 hover:bg-emerald-50"
