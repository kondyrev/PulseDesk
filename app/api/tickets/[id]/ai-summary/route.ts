...
export async function POST(
  ...
  try {
    ...
    const systemPrompt = `
      ...
      - Если клиент явно просит подключение специалиста,
        эскалацию обращения,
        руководителя,
        или сообщает,
        что уже выполнил предложенные проверки,

        не предлагай повторную диагностику.

        Рассматривай возможность эскалации
        как следующий шаг.
