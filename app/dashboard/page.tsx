        ...
        <aside className="space-y-6">
          <div className="rounded-[36px] border border-black/[0.04] bg-white p-6 shadow-sm">
            <div className="mb-6 flex items-center justify-between">
              <h3 className="text-xl font-bold tracking-tight">AI Copilot</h3>
          ...
          <div className="rounded-[36px] border border-black/[0.04] bg-black p-6 text-white shadow-2xl">
            ...
            <p className="leading-relaxed text-zinc-400">
              AI summary и suggested replies сокращают ручную работу и помогают
              сохранить качество общения.
            </p>
          </div>
        </aside>
      </section>
